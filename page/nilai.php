...
<div class="row">
	<div class="col-md-4">
	    <div class="panel panel-<?= ($update) ? "warning" : "info" ?>">
	        <div class="panel-heading"style="background-color: #87CEFA" ><h3 class="text-center" style="color: #FFFFFF"><?= ($update) ? "EDIT" : "TAMBAH" ?></h3></div>
	            ...
	            <form action="<?=$_SERVER["REQUEST_URI"]?>" method="post">
	                  ...
	                  <label for="kd_beasiswa">Beasiswa</label>
				                ...
				                <div class="form-group">
									...
									<?php endif; ?>
	                <button type="submit" id="simpan" class="btn btn-<?= ($update) ? "warning" : "info" ?> btn-block" style="background-color: #87CEFA"><?=($_POST) ? "Simpan" : "Tampilkan"?></button>
	                <?php if ($update): ?>
